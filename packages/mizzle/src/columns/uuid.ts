...
export class UUIDColumn<T extends ColumnBaseConfig<"string", "S">> extends Column<T> {}

export function uuid(): UUIDColumnInitial<"">;
export function uuid<TName extends string>(name: TName): UUIDColumnInitial<TName>;
/**
