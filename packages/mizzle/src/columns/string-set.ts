...
export type StringSetColumnInitial<TName extends string> = StringSetColumnBuilder<{
  name: TName;
  dataType: "string";
  columnType: "SS";
  data: Set<string>;
...
export class StringSetColumn<T extends ColumnBaseConfig<"string", "SS">> extends Column<T> {}

export function stringSet(): StringSetColumnInitial<"">;
export function stringSet<TName extends string>(name: TName): StringSetColumnInitial<TName>;
/**
