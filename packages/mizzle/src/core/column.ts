...
> = Column<Required<Update<ColumnBaseConfig<string, ColumnDataType>, TPartial>>>;
...
export abstract class Column<
  T extends ColumnBaseConfig<string, ColumnDataType> = ColumnBaseConfig<string, ColumnDataType>,
