...
export type BuildExtraConfigColumns<TConfigMap extends Record<string, ColumnBuilderBase>> =
...
export interface ColumnBuilderBase<
  T extends ColumnBuilderBaseConfig<string, ColumnDataType> = ColumnBuilderBaseConfig<
    string,
    ColumnDataType
  >,
  TTypeConfig extends object = object,
...
export type BuildColumn<TTableName extends string, TBuilder extends ColumnBuilderBase> = Column<
