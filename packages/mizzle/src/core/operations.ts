...
export type SelectedFieldsFlat<TColumn extends Column> = Record<string, TColumn>;

export type SelectedFields<TColumn extends Column, TTable extends PhysicalTable> = Record<
  string,
