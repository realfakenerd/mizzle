...
- [**Insert:**](/reference/querying/insert) Create new items.
- [**Update:**](/reference/querying/update) Modify existing items with granular actions (`SET`, `ADD`, `REMOVE`, `DELETE`).
- [**Delete:**](/reference/querying/delete) Remove items from the table.
