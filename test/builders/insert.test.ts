...
import { string, uuid, number, boolean, list, map, stringSet, numberSet } from "@aurios/mizzle/columns";
import { prefixKey, staticKey } from "@aurios/mizzle";
import { DynamoDBClient, CreateTableCommand, DeleteTableCommand } from "@aws-sdk/client-dynamodb";
import { DynamoDBDocumentClient, GetCommand } from "@aws-sdk/lib-dynamodb";
import { InsertBuilder } from "@aurios/mizzle";
...
describe("Insert Command", () => {
    ...
    it("should auto-generate UUID and resolve keys if not provided", async () => {
        ...
        const data = {
            ...
            age: 20,
            active: true,
        } as any; // Cast to unknown to skip required id check for test
