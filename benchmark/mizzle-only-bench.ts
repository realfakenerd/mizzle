  ...
  for (const scale of scales) {
    ...
    const operations: Operation[] = [
      ...
      },
      {
        name: "GetItem",
        run: async (b, i) => {
          await b.getItem(i.pk, i.sk);
        },
      },
      {
        name: "UpdateItem",
        run: async (b, i) => {
          await b.updateItem(i.pk, i.sk, { name: "Updated Name" });
        },
      },
      {
        name: "Query",
        run: async (b, i) => {
          await b.queryItems(i.pk);
        },
      },
      {
        name: "Scan",
    ...
    for (const op of operations) {
      ...
      bench.add(
        ...
        {
          beforeAll: function () {
            collector.beforeAll(this);
          },
          afterAll: function () {
            collector.afterAll(this);
          },
        },
      );
